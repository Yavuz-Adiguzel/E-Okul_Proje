...
namespace E_OKUL_UYGULAMA.DataSet1TableAdapters {
    ...
    public partial class TBLDERSLERTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::E_OKUL_UYGULAMA.Properties.Settings.Default.BonusOkulConnectionString;
        }
    ...
    public partial class DataTable1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        TBLOGRENCILER.OGRID, TBLOGRENCILER.OGRAD, TBLOGRENCILER.OGRSOYAD, T" +
                "BLOGRENCILER.OGRCİNSİYET, TBLKULUPLER.KULUPAD\r\nFROM            TBLKULUPLER INNER" +
                " JOIN\r\n                         TBLOGRENCILER ON TBLKULUPLER.KULUPID = TBLOGRENC" +
                "ILER.OGRKULUP";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"SELECT        TBLOGRENCILER.OGRID, TBLOGRENCILER.OGRAD, TBLOGRENCILER.OGRSOYAD, TBLOGRENCILER.OGRCİNSİYET, TBLKULUPLER.KULUPAD
...
WHERE OGRAD=@OGRAD";
            ...
            this._commandCollection[3].CommandText = "UPDATE       TBLOGRENCILER\r\nSET                OGRAD = @OGRAD, OGRSOYAD = @OGRSOY" +
                "AD, OGRKULUP = @OGRKULUP, OGRCİNSİYET = @OGRCINSIYET where OGRID=@OGRID";
            this._commandCollection[3].CommandType = global::System.Data.CommandType.Text;
    ...
    public partial class TBLNOTLARTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = @"SELECT        TBLNOTLAR.NOTID, TBLNOTLAR.OGRID, TBLNOTLAR.SINAV1, TBLNOTLAR.SINAV2, TBLNOTLAR.SINAV3, TBLNOTLAR.PROJE, TBLNOTLAR.ORTALAMA, TBLNOTLAR.DURUM, TBLDERSLER.DERSAD
